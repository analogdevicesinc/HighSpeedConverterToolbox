classdef Rx < adi.AD9084.Base & adi.common.Rx & adi.common.Attribute
    % adi.AD9084.Rx Receive data from the AD9084 high speed ADC
    %   The adi.AD9084.Rx System object is a signal source that can receive
    %   complex data from the AD9084.
    %
    %   rx = adi.AD9084.Rx;
    %   rx = adi.AD9084.Rx('uri','ip:192.168.2.1');
    %
    %   <a href="http://www.analog.com/media/en/technical-documentation/data-sheets/AD9084.pdf">AD9084 Datasheet</a>
    %
    %   See also adi.QuadAD9084.Rx
