    ...
    switch $project {
        ...
        ad9695_fmc {            
            if {$rxtx == "rx"} {
                ...
                #Remove decimators
                delete_bd_objs [get_bd_nets rx_ad9695_tpl_core_adc_data_0] [get_bd_nets rx_ad9695_tpl_core_adc_data_1] [get_bd_nets rx_ad9695_tpl_core_adc_enable_0] [get_bd_nets rx_ad9695_tpl_core_adc_enable_1] [get_bd_nets rx_ad9695_tpl_core_adc_valid_0] 
                
                # Connect the ADC PACK valid signals together
                connect_bd_net [get_bd_pins util_ad9695_rx_cpack/enable_0] [get_bd_pins util_ad9695_rx_cpack/enable_1]
                # Connect enables
                connect_bd_net [get_bd_pins rx_ad9695_tpl_core/adc_enable_0] [get_bd_pins util_ad9695_rx_cpack/enable_0]  
            }
            switch $carrier {                
                zcu102 {  
                    ...
                    connect_bd_net [get_bd_pins axi_cpu_interconnect/aclk1] [get_bd_pins rx_core_clk_0]       
                    #connect_bd_net [get_bd_pins axi_cpu_interconnect/M05_ARESETN] [get_bd_pins ad9695_rx_device_clk_rstgen/peripheral_reset]
                }                
            }
        }
        ad9081_fmca_ebz {
