    ...
    switch $project {
        ...
        fmcomms11 {
            ...
            switch $carrier {                
                zc706 {                    
                    if {$rxtx == "rx" || $rxtx == "rxtx"} {
                        set_property -dict [list CONFIG.NUM_MI {15}] [get_bd_cells axi_cpu_interconnect]
                        connect_bd_net [get_bd_pins axi_cpu_interconnect/M14_ACLK] [get_bd_pins util_fmcomms11_xcvr/rx_out_clk_0]
                    }
                    if {$rxtx == "tx"} {
                        set_property -dict [list CONFIG.NUM_MI {15}] [get_bd_cells axi_cpu_interconnect]
                        connect_bd_net [get_bd_pins axi_cpu_interconnect/M14_ACLK] [get_bd_pins util_fmcomms11_xcvr/tx_out_clk_0]
                    }
                }
            }
        }      
