...
if contains(lower(type),'tx')
    ...
    hRD.addInternalIOInterface( ...
        ...
        'InterfaceType',  'IN', ...
        'PortName',       'tx_dut_data_valid', ...
        'PortWidth',      1, ...
        'InterfaceConnection', [tx_upack_core,'/dac_valid_out_0'], ...
        'IsRequired',     false);
    ...
    for k=0:tx_ports-1
        % DUT inputs
        hRD.addInternalIOInterface( ...
            'InterfaceID',    ['DMA Data ',num2str(k),' IN'], ...
            'InterfaceType',  'IN', ...
        ...
        hRD.addInternalIOInterface( ...
            ...
            'InterfaceType',  'OUT', ...
            'PortName',       ['tx_dut_data_',num2str(k)], ...
            'PortWidth',      tx_data_widths, ...
            'InterfaceConnection', [tx_sink_core,'/dac_ddata_',num2str(k)]', ...
            'IsRequired',     false);
    end
