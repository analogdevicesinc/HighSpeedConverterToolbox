...
rd = {...
    'AnalogDevices.lldk_fmc.zed.plugin_rd_rx', ...
    'AnalogDevices.lldk_fmc.zed.plugin_rd_tx', ...
    'AnalogDevices.lldk_fmc.zed.plugin_rd_rxtx', ...
    };

boardName = 'AnalogDevices LLDK ZED';
