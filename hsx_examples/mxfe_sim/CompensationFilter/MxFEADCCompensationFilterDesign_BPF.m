...
stopPercentStart = 0.1910; % Normalized frequency stop point of first band
passPercentStop = 0.24; % Normalized frequency start point of second band
stopPercentStart1 = 0.414613; % Normalized frequency stop point of first band
passPercentStop1 = stopPercentStart1 + passPercentStop - stopPercentStart; % Normalized frequency start point of second band
...
%% Generic BPF
d = fdesign.bandpass('N,Fst1,Fp1,Fp2,Fst2,C',FilterOrder-1,stopPercentStart,passPercentStop,stopPercentStart1,passPercentStop1);
...
Hd.Numerator = qt./2^18;

%%Convert to hex for part injest by ACE
% tapsHex = dec2hex(abs(qt),4);
% xt=qt';
