classdef Rx < adi.QuadAD9084.Base & adi.common.Rx
    % adi.QuadAD9084.Rx Receive data from the QuadAD9084 development board
    %   The adi.QuadAD9084.Rx System object is a signal source that can receive
    %   complex data from the QuadAD9084.
    %
    %   rx = adi.QuadAD9084.Rx;
    %   rx = adi.QuadAD9084.Rx('uri','ip:192.168.2.1');
    %
...
%     end
    ...
    properties(Nontunable, Hidden)
        ...
        devName0 = '';
        devName1 = 'axi-ad9084-rx1'; %Apollo1
        devName2 = 'axi-ad9084-rx2'; %Apollo2
        devName3 = 'axi-ad9084-rx3'; %Apollo3
    end
    ...
    methods
        ...
        function obj = Rx(varargin)
            ...
            obj = obj@adi.QuadAD9084.Base(varargin{:});
            obj.uri = 'ip:analog';
            obj.channel_names = {};
        ...
        function set.ChannelNCOFrequenciesChipB(obj, value)
            obj.CheckAndUpdateHW(value,'ChannelNCOFrequenciesChipB',...
        ...
        function set.ChannelNCOFrequenciesChipD(obj, value)
            obj.CheckAndUpdateHW(value,'ChannelNCOFrequenciesChipD',...
                'channel_nco_frequency', obj.iioDev3);
        ...
        function set.MainNCOFrequenciesChipB(obj, value)
            obj.CheckAndUpdateHW(value,'MainNCOFrequenciesChipB',...
        ...
        function set.MainNCOFrequenciesChipD(obj, value)
            obj.CheckAndUpdateHW(value,'MainNCOFrequenciesChipD',...
                'main_nco_frequency', obj.iioDev3);
        ...
        function set.ChannelNCOPhasesChipB(obj, value)
            obj.CheckAndUpdateHW(value,'ChannelNCOPhasesChipB',...
        ...
        function set.MainNCOPhasesChipB(obj, value)
            obj.CheckAndUpdateHW(value,'MainNCOPhasesChipB',...
...
%                 writeFilterFile(obj,obj.iioDev3,value);
%             end
%         end
...
%   Check ExternalAttenuation
    ...
    function [tempApollo0, tempApollo1, tempApollo2, tempApollo3] = readApolloTemp(obj)
        tempApollo0 = obj.getAttributeDouble('temp0','input',false,obj.iioDev0);
        tempApollo1 = obj.getAttributeDouble('temp0', 'input',false,obj.iioDev1);
        tempApollo2 = obj.getAttributeDouble('temp0', 'input',false,obj.iioDev2);
        tempApollo3 = obj.getAttributeDouble('temp0' ,'input',false,obj.iioDev3);
    end
...
%             xmlData = calllib(obj.libName, 'iio_context_get_xml', obj.iioCtx);
            ...
            obj.iioDev23 = getDev(obj, 'iio:device33'); %dsa0
            obj.iioDev24 = getDev(obj, 'iio:device34'); %dsa1
            obj.iioDev25 = getDev(obj, 'iio:device35'); %dsa2
            obj.iioDev26 = getDev(obj, 'iio:device36'); %dsa3
            obj.iioDev10 = getDev(obj, 'iio:device13'); %lpf-ctrl
            obj.iioDev11 = getDev(obj, 'iio:device14'); %hpf-ctrl
...
%                 obj.iioAD5592r = getDev(obj, 'ad5592r');
            ...
            %%
            if obj.EnableDevice3
            obj.setAttributeRAW('voltage0_i','test_mode',...
                obj.TestModeChipD,false,obj.iioDev3);
