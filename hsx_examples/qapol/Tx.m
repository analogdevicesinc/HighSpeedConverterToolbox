classdef Tx < adi.QuadAD9084.Base & adi.common.Tx
    % adi.QuadAD9084.Tx Transmit data from the QuadAD9084 development board
    %   The adi.QuadAD9084.Tx System object is a signal sink that can tranmsit
    %   complex data from the QuadAD9084.
    %
    %   tx = adi.QuadAD9084.Tx;
    %   tx = adi.QuadAD9084.Tx('uri','ip:192.168.2.1');
    %
    ...
    methods
        ...
        function obj = Tx(varargin)
            ...
            obj.NCOEnablesChipA = ones(1,obj.num_fine_attr_channels) > 0;
            obj.NCOEnablesChipB = ones(1,obj.num_fine_attr_channels) > 0;
            obj.NCOEnablesChipC = ones(1,obj.num_fine_attr_channels) > 0;
            obj.NCOEnablesChipD = ones(1,obj.num_fine_attr_channels) > 0;
        end
...
%                 end
        ...
        function setupInit(obj)
            ...
            for k=0:3
                obj.(sprintf('iioDevADF4382_%d',k)) = ...
